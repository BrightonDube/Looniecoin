...
"""Verify that starting looniecoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start looniecoin with -h for help text")
        ...
        self.log.info("Start looniecoin with -version for version information")
