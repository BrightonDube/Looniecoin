...
#if defined(NDEBUG)
# error "Looniecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Looniecoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LNI additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("looniecoin-scriptch");
