...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s looniecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  looniecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded looniecoin transaction") + "\n" +
              "  looniecoin-tx [options] -create [commands]   " + _("Create hex-encoded looniecoin transaction") + "\n" +
              "\n";
