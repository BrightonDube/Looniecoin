...
{
    const char* pszTimestamp = "BBC News 11/Oct/2018 Apple hires engineers from UK company Dialog";
    const CScript genesisOutputScript = CScript() << ParseHex("04ffff001d010441424243204e6577732031312f4f63742f32303138204170706c6520686972657320656e67696e656572732066726f6d20554b20636f6d70616e79204469616c6f67") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 2.5 * 60; //30 Seconds        
        ...
        genesis = CreateGenesisBlock(1539452987, 2091339225, 0x1e0ffff0, 1, 45 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcfb7f0552c6ffda0c73f2ae568debf3a90ffac6873ff5b292c642fe093687e5e"));
        ...
        // vSeeds.emplace_back("dnsseed.looniecointools.com");
        // vSeeds.emplace_back("dnsseed.looniecoinpool.org");
        // vSeeds.emplace_back("dnsseed.koin-project.com");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,48);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,50);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,4);
        ...
        chainTxData = ChainTxData{
            ...
            1539327533, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 0.25 * 24 * 60 * 60; // 6hrs
        consensus.nPowTargetSpacing = 2.5 * 60; //30 seconds
        ...
        genesis = CreateGenesisBlock(1486949366, 2091339225, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.looniecointools.com");
        vSeeds.emplace_back("seed-b.looniecoin.loshan.co.uk");
