...
* looniecoin.conf: contains configuration settings for looniecoind or looniecoin-qt
* looniecoind.pid: stores the process id of looniecoind while running
...
* debug.log: contains debug information and general logging generated by looniecoind or looniecoin-qt
