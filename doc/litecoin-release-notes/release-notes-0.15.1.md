Looniecoin Core version *0.15.1* is now available from:

  <https://download.looniecoin.org/looniecoin-0.15.1/>
...
A number of changes to the way Looniecoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 loonies per kB (0.00001 LNI). This is to prepare for dropping the minimum transaction fee to 0.1 loonies per kB (0.0001 LNI) in the next release.
